...
describe('Phase 2 â€” Card tags (Â§15.4)', () => {
    describe('canonical casing', () => {
        ...
        it('matches case-insensitively, whatever casing the consumer uses', () => {
            // The mutator system's `tokenMatchesTags` used to assert this pair.
            // It is deleted, but the rule it depended on is a property of
