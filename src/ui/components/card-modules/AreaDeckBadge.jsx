    ...
    return (
        <div className={cn(
            ...
            {(currentDepth !== undefined && maxDepth !== undefined) && (
                <div className="flex items-center gap-1.5 px-2 py-0.5 bg-black/40 rounded border border-white/10 shadow-sm">
            ...
            {threatLevel !== undefined && (
                <div className={cn(
                    ...
                    isHighThreat
                        ? "bg-gi-danger/20 border-gi-danger/50 text-gi-danger"
