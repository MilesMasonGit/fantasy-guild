...
const watchConfigs = [
  ...
  },
  {
    ...
    outputDir: path.join(__dirname, '..', 'raw_assets', 'dataset'),
    backupDir: path.join(__dirname, '..', 'raw_assets', 'dataset', '512input32', 'backup'),
    category: 'raw_assets/dataset',
    size: 32
  },
  {
    name: 'Sprites (512px to 64px)',
    inputDir: path.join(__dirname, '..', 'raw_assets', 'dataset', '512input64'),
    outputDir: path.join(__dirname, '..', 'raw_assets', 'dataset'),
    backupDir: path.join(__dirname, '..', 'raw_assets', 'dataset', '512input64', 'backup'),
    category: 'raw_assets/dataset',
    size: 64
  },
  {
  ...
  },
  {
    ...
    inputDir: path.join(__dirname, '..', 'raw_assets', 'dataset', '512input256'),
    outputDir: path.join(__dirname, '..', 'raw_assets', 'dataset'),
    backupDir: path.join(__dirname, '..', 'raw_assets', 'dataset', '512input256', 'backup'),
    category: 'raw_assets/dataset',
    size: 256,
    extraArgs: '--nofill'
  }
